                ...
                <div class="content custom-scrollbar">
                    ...
                    <div id="e-commerce-product" class="page-layout simple tabbed">
                        ...
                        <div class="page-header bg-secondary text-auto row no-gutters align-items-center justify-content-between p-6">
                            ...
                            <div class="row no-gutters align-items-center" id="MASSAGE">

                                <a href="../group/Gorups_List.php" class="btn btn-icon mr-4">
                                    ...
                                    <div class="card p-6">
                                        ...
                                        <form id="PostForm">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="hidden" name="GROUP_LIST" value="<?php echo $id;?>" id="GROUP_LIST"/>
                    ...
                    <script type="text/javascript" src="new_grop_multi.js"></script>
