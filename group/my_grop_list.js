...
function loadTableIndex() {
    var url = "../req_group/my_group_list.php?i=1";
    $.ajax({
        type: "GET",
        url: url,
            ...
            if (parseInt(json.SUCCESS) === 1) {
                ...
                for (var i = 0; i < json.CONTENTS.length; i++) {
                    ...
                    + "<td class='type d-none d-md-table-cell'>" + json.CONTENTS[i].GROUP_TYPE + "</td>"
                                ...
                                + "<td class='last-modified d-none d-lg-table-cell'><a href=Group_Details.php?id=" + parseInt(json.CONTENTS[i].GROUP_ID) + "' class='btn btn-success btn-sm'>View</a></td>"
                                + "<td class='d-table-cell d-xl-none'>"
                                + "<a class='btn btn-icon' href='Group_Details.php?id=" + parseInt(json.CONTENTS[i].GROUP_ID) + "'>"
